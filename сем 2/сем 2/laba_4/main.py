...
# Приложение с графическим интерфейсом для решения поставленной задачи. Приложение позволяет пользователю задавать параметры фигур 
# как с помощью клавиатуры вводя цифровые значения, так и задавая мышкой характеристики фигуры на поле графического экрана.
...
# Создаётся строчка "Координаты основной точки:"
label1 = tk.Label(text="Координаты основной точки:", font = ("Calibry", 11))
...
# Создаётся строчка "Координаты дополнительной точки:"
label2 = tk.Label(text="Координаты дополнительной точки:", font = ("Calibry", 11))
...
cnv.bind('<Button-1>', lambda event: touch(event, cnv, x1, y1, x2, y2))
cnv.bind('<Button-2>', lambda event: fork('Отрисовать\nпрямую', x1, y1, x2, y2, cnv))
cnv.bind('<Button-3>', lambda event: fork('Очистить\nосновную\nточку', x1, y1, x2, y2, cnv))
#cnv.bind('<Return>', lambda event: fork('Построить\nрезультирующую\nпрямую', x1, y1, x2, y2, cnv))

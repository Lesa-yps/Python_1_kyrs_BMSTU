...
menu_in.add_command(label = 'Изменить изображение', command = lambda: fork('ЗАШИФРОВАТЬ', stika, stika_out, way, way_out))
menu_in.add_command(label = 'Вывести начальное изображение', command = lambda: fork('РАСШИФРОВАТЬ', stika, stika_out, way, way_out))
menu_in.add_command(label = 'Вывести изменённое изображение', command = lambda: fork('Очистить шифруемую\n строку', stika, stika_out, way, way_out))

...
window = tk.Tk()
window.geometry(f"235x320+100+200")
...
def diff_4(num1, num2):
    ...
    for i in range(len(num1)):
        if num1[-1] == '.':
            ...
            a = 1 if int(num1[-1]) < int(num2[-1]) else 0
...
def cleaner(value1):
    ...
    calc.insert(calc.index('insert') - 1, value1)
...
def add_digit(digit):
    ...
    if digit in '0123':
        ...
        try:
            ...
            # Вывод ошибки
            errors.config(text = 'Выражение некорректно')
        else:
            value1 = brain(value1)
    elif digit == '<-':
...
make_button('C').grid(row = 1, column = 0, stick = 'wens', padx = 5, pady = 5, columnspan = 2)
make_button('<-').grid(row = 1, column = 2, stick = 'wens', padx = 5, pady = 5)
make_button('1').grid(row = 2, column = 0, stick = 'wens', padx = 5, pady = 5)
make_button('2').grid(row = 2, column = 1, stick = 'wens', padx = 5, pady = 5)
make_button('3').grid(row = 2, column = 2, stick = 'wens', padx = 5, pady = 5)
make_button('0').grid(row = 3, column = 0, stick = 'wens', padx = 5, pady = 5, columnspan = 2)
make_button('.').grid(row = 3, column = 2, stick = 'wens', padx = 5, pady = 5)
make_button('+').grid(row = 4, column = 0, stick = 'wens', padx = 5, pady = 5)
make_button('-').grid(row = 4, column = 1, stick = 'wens', padx = 5, pady = 5)
make_button('=').grid(row = 4, column = 2, stick = 'wens', padx = 5, pady = 5)

# Создаётся строчка "Ошибки:"
label3 = tk.Label(text="Ошибки:", font = ("Calibry", 11))
label3.grid(row = 5, column = 0, columnspan = 3, sticky = 'w')

# Создаётся строчка для вывода ошибок с начальным значением "   Ошибок нет."
errors = tk.Label(text='   Ошибок нет.', font = ("Calibry", 13))
errors.grid(row = 6, column = 0, columnspan = 3, sticky = 'w')
